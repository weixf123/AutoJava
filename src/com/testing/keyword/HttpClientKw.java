...
//		}
	...
	public String doPostSoap(String url, String soapParam) throws Exception{
		String body = "";
...
//			httpPost.setConfig(config);
			...
			//将XML数据以实体形式添加到请求中
			StringEntity soapReq=new StringEntity(soapParam,Charset.forName("UTF-8"));
//			soapReq.setContentEncoding("utf-8");
//			soapReq.setContentType("text/xml;charset=utf-8");
			httpPost.setEntity(soapReq);
