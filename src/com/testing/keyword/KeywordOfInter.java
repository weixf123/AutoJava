...
public class KeywordOfInter {
	...
	public String testPost(String url,String input) {
		try {
			String newurl =toParam(url);
			String param=toParam(input);
//			System.out.println("param:"+param);
			tmpResponse =client.doPost(newurl, param);
			return tmpResponse;
		} catch (Exception e) {
...
//			System.out.println("param:"+param);
	...
	public String testPostSoap(String url,String soapInput) {
		try {
			String param=toParam(soapInput);
//			param=URLEncoder.encode(param, "utf-8");
//			System.out.println("param:"+param);
			tmpResponse =client.doPostSoap(url, param);
			return tmpResponse;
		} catch (Exception e) {
			AutoLogger.log.error("post方法发送失败，请检查");
			AutoLogger.log.error(e,e.fillInStackTrace());
	...
	public String testPostUpload(String url,String inputFile) {
		try {
			tmpResponse =client.doUpload(url, inputFile);
			return tmpResponse;
		} catch (Exception e) {
